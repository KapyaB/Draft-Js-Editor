  ...
  */
   ...
   */
                           ...
                           const handleColorChangeComplete = color => {
                             const newEditorState = styles.color.toggle(
                               editorState,
                               color
                             );
                           ...
                           const onFontSelect = font => {
                             ...
                             setShowFonts(false);
                             setEditorState(
                               RichUtils.toggleInlineStyle(editorState, font)
                             );
                           };
    ...
    */
                           ...
                           const onAlignClick = alignment => {
                             ...
                             [...allBlockNodes].map(block => {
                               const anchorKey = block
                                 .getAttribute('data-offset-key')
                                 .split('-')[0];
                               const selectedBlockKey = editorState
                                 .getSelection()
                                 .getAnchorKey();
                           ...
                           const allBlocks = convertToRaw(
                             editorState.getCurrentContent()
                           ).blocks;
                           const selectedKey = editorState
                             .getSelection()
                             .getAnchorKey();
                           ...
                           const currentInlineStyles =
                             selectedBlock.inlineStyleRanges; //array of objects
                           const currentBlockStyle = selectedBlock.type;
                           const selectionOffset = editorState
                             .getSelection()
                             .getAnchorOffset(); // position of cursor or start of selection
                           ...
                           if (selectedBlockNode) {
                             if (selectedBlockNode.classList.length > 2) {
                               const alignStyle =
                                 selectedBlockNode.classList[2];
                               !activeStyles.includes(alignStyle) &&
                                 ...
                                 <div className="inline-styles">
                                   ...
                                   <button
                                     className={`highlight-btn style-btn ${
                                       activeStyles.includes('HIGHLIGHT')
                                         ? 'active-btn'
                                         : null
                                     }`}
                                   ...
                                   <button
                                     className={`strike-through-btn style-btn ${
                                       activeStyles.includes('STRIKETHROUGH')
                                         ? 'active-btn'
                                         : null
                                     }`}
                                   ...
                                   <button
                                     className={`superscript-btn style-btn ${
                                       activeStyles.includes('SUPERSCRIPT')
                                         ? 'active-btn'
                                         : null
                                     }`}
                                   ...
                                   <button
                                     className={`subscript-btn style-btn ${
                                       activeStyles.includes('SUBSCRIPT')
                                         ? 'active-btn'
                                         : null
                                     }`}
              ...
              H1
                                   ...
                                   <button
                                     className={`blockquote-btn style-btn ${
                                       activeStyles.includes('blockquote')
                                         ? 'active-btn'
                                         : null
                                     }`}
                                   ...
                                   <button
                                     className={`codeblock-btn style-btn ${
                                       activeStyles.includes('code-block')
                                         ? 'active-btn'
                                         : null
                                     }`}
                                   ...
                                   <div className="align-tools">
                                     <button
                                       className={`align-left style-btn ${
                                         activeStyles.includes('align-left')
                                           ? 'active-btn'
                                           : null
                                       }`}
                                       onClick={() =>
                                         onAlignClick('align-left')
                                       }
                                     >
                                     ...
                                     <button
                                       className={`align-center style-btn ${
                                         activeStyles.includes('align-center')
                                           ? 'active-btn'
                                           : null
                                       }`}
                                       onClick={() =>
                                         onAlignClick('align-center')
                                       }
                                     >
                                     ...
                                     <button
                                       className={`align-right style-btn ${
                                         activeStyles.includes('align-right')
                                           ? 'active-btn'
                                           : null
                                       }`}
                                       onClick={() =>
                                         onAlignClick('align-right')
                                       }
                                     >
                                     ...
                                     <button
                                       className={`align-justify style-btn ${
                                         activeStyles.includes('align-justify')
                                           ? 'active-btn'
                                           : null
                                       }`}
                                       onClick={() =>
                                         onAlignClick('align-justify')
                                       }
                                     >
